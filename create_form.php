...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($_POST as $key => $value) {
        if ($key !== 'form_id') {
            $form_fields[$key] = htmlspecialchars($value);
        }
    }
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand" href="#">Submission Successful</a>
            </div>
        </nav>
        <div class="container text-center">
            <div class="alert alert-success">
                <h4 class="alert-heading">Success!</h4>
                <p>Your form has been submitted successfully. You will be redirected to the homepage shortly.</p>
                <hr>
                <p class="mb-0">Redirecting in <span id="countdown">5</span> seconds...</p>
            </div>
        </div>
